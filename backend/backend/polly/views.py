...
class PollyViewSet(APIView):
    ...
    def __init__(self, bucket_name=env('AWS_BUCKET_NAME')) -> None:
    ...
    def get(self, request):
        ...
        audio_url = self.polly_service.retrieve_audio_url(
            bucket=self.bucket, identifier=audio_identifier)
    ...
    def post(self, request):
        ...
        polly_response = self.polly_service.use_polly(
            user_input, self.bucket, identifier)
